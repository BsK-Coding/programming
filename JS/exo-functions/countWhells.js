...
console.log(`Nbr de roues dans le Garage 1:`, countWheels(10, 20, 7, 2))     // Garage 1: console.log(countWheels(nb_monocycle, nb_moto, nb_voiture, nb_limousine))
console.log(`Nbr de roues dans le Garage 2:`, countWheels(2, 3, 4, 5))       // Garage 2: console.log(countWheels(nb_monocycle, nb_moto, nb_voiture, nb_limousine))