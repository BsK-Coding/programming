...
for (let i = 0; i < splitText.length; ++i) {
  if (splitText[i] === prenom)
    prenom = text.replace(/Alice/gi, "Michel")  // replace() n'affecte que la première valeur, mais nous pouvons utiliser l'indicateur "g" (global) pour attraper toutes les instances d'une valeur et l'indicateur "i" (insensible à la casse) pour ignorer la casse.
